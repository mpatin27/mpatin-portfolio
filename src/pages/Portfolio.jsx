              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="pt-4 border-t border-slate-800 flex justify-between items-center">
                    <div className="text-xs text-green-600 font-bold flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <span>[ + DETAILS ]</span>
                    </div>
                    {project.repo_link && (
                      <a href={project.repo_link} target="_blank" onClick={(e) => e.stopPropagation()} className="text-slate-400 hover:text-white text-sm flex items-center gap-2 transition">
